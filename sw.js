const CACHE='miniature-frame-selector-v1';
const SHELL=['./','./index.html','./styles.css','./app.js','./manifest.webmanifest','./icons/icon.svg','./image-library/catalogue-image-map.json'];
